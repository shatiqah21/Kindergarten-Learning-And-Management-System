...
class AddTransitDaycareToStudentRecordss extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('student_records', function (Blueprint $table) {
            if (!Schema::hasColumn('student_records', 'transit_id')) {
            ...
            if (!Schema::hasColumn('student_records', 'daycare_id')) {
