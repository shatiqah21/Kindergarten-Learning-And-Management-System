...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['my_class_id', 'section_id', 'my_parent_id', 'dorm_id', 'dorm_room_no', 'year_admitted', 'house', 'age', 'add_on'];
    ...
    {
    return in_array(Auth::user()->user_type, ['super_admin', 'admin']);
    }
   ...
   public static function userIsStudent()
    {
    return in_array(Auth::user()->user_type, ['student', 'parent']);
    }
   ...
   public static function getSetting($type)
{
   ...
   public static function getSystemName() {
    return env('APP_NAME', 'PASTI FIRDAUS');
    }
