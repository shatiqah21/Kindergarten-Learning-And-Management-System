                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <i class="icon-user-tie icon-2x text-warning-400 border-warning-400 border-3 rounded-round p-3 mb-3 mt-1"></i>
                            ...
                            <div class="text-center mb-3">
                                ...
                                <a href="{{ route('register') }}" class="btn btn-outline-primary btn-sm ml-2">
                                    Register
                                </a>
                            </div>
