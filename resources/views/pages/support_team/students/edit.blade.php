                ...
                <fieldset>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="add_on" id="add_on" class="form-control">
                                <option value="">-- Select --</option>
                                <option value="Transit" {{ old('add_on', $sr->add_on) == 'Transit' ? 'selected' : '' }}>Transit</option>
                                <option value="Daycare" {{ old('add_on', $sr->add_on) == 'Daycare' ? 'selected' : '' }}>Daycare</option>
                            </select>
                        </div>
                    </div>
