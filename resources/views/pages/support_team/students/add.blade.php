                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="add_on" id="add_on" class="select-search form-control" data-placeholder="Choose...">
                                    <option value=""></option>
                                    <option {{ (old('add_on') == 'transit') ? 'selected' : '' }} value="Transit">Transit</option>
                                    <option {{ (old('add_on') == 'daycare') ? 'selected' : '' }} value="Daycare">Daycare</option>
                                </select>
                            </div>
                        </div>
                    </div>
