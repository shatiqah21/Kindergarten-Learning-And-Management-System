                   ...
                   <thead>
                    ...
                    <tbody>
                        @foreach($students as $s)
                            @php
                                $latestPayment = \App\Models\Payment::where('my_parent_id', $s->user_id)
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            ...
                                            @foreach(Pay::getYears($s->user_id) as $py)
                                                ...
                                                @endif
                                            @endforeach
                                            @if($latestPayment && $latestPayment->method == 'stripe' && $latestPayment->status == 'success')
                                                <a href="{{ $latestPayment->receipt_url }}" class="dropdown-item" target="_blank">Download Stripe Receipt</a>
                                            @endif
                                        </div>
                                    </div>
                                </td>
