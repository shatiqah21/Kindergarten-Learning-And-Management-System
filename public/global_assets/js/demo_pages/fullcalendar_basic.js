...
var FullCalendarBasic = function() {
    ...
    var _componentFullCalendarBasic = function() {
       ...
       $('.fullcalendar-basic').fullCalendar({
            ...
            editable: true,
            events: events, // <-- or load from your DB/API
            eventLimit: true,
            ...
            eventClick: function(event, jsEvent, view) {
                ...
                $('#edit_event_id').val(event._id); // or event.id if you use DB IDs
                $('#edit_title').val(event.title);
                $('#edit_start').val(moment(event.start).format('YYYY-MM-DDTHH:mm'));
                if (event.end) {
                    $('#edit_end').val(moment(event.end).format('YYYY-MM-DDTHH:mm'));
                } else {
                    $('#edit_end').val('');
                }

                // dynamically set form action
                var url = "{{ url('/events') }}/" + event.id;
